#
#    Exercício 14 da maratona de 3 meses
...
peso = float(input('Digite quantos quilos de peixe foram pescados: '))
...
print('Foram pescados', str(format(peso, '.2f'))+'kg de peixes.')
if excesso == 0:
    print('Não há multa.')
else:
    print('Com excesso de', str(format(excesso, '.2f'))+'kg, a multa é de R$', format(multa, '.2f'))